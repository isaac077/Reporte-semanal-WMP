    ...
    <div className="min-h-screen bg-slate-100/70 text-slate-900 font-sans flex flex-col justify-between">
      ...
      <footer className="bg-slate-900 text-slate-400 text-xs py-6 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="w-6 h-6 rounded-full bg-[#0F3D64] flex items-center justify-center text-white text-[10px] font-bold">
              WMP
            </div>
            <span className="font-semibold text-slate-200">WMP Mexico Advisors</span>
          </div>
        </div>
      </footer>
